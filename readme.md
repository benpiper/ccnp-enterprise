...
| [BGP and Path Control](bgp-path-control) | 1.7 Differentiate hardware and software switching mechanisms, 2.2 Configure and verify data path virtualization technologies, 3.2 Layer 3, 4.5 Configure and verify IPSLA | 4.5 Troubleshoot network performance issues using IP SLA (jitter, tracking objects, delay, connectivity) |  |
